  ...
  return (
    <div className="flex flex-col w-full">
      ...
      {postData.map((post) => {
        return (
          <Card
            className="flex flex-col mb-6  icon-bg-light dark:icon-bg-dark dark:container-bg-dark container-bg-light w-full "
            key={post.postId}
          >
            ...
            <CardContent className="relative aspect-square object-contain ">
              <Image
