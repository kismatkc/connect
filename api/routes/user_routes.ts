...
router.post("/create-messages", userController.createMessages);
router.get("/get-chats", userController.getChats);
router.post("/get-support", userController.getSupport);
router.post("/get-last-messages", userController.getLastMessages);
